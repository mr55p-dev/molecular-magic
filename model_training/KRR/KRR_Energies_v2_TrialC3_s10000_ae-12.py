...
alpha = 1e-12                # size of the regularisation
filename = 'KRR_Energies_v2'
save_directory = 'TrialC3'
version = 'TrialC3_s10000_ae-12'
Test_Size = 0.33
Random_State = 42
...
X = np.load('./CreateFeatures_v20_fAng_fNH_B0p07_A0p07_G298/GDBA_CreateFeatures_v20_fAng_fNH_B0p07_A0p07_G298_v1_f781_X.npy', allow_pickle=True)
y = np.load('./CreateFeatures_v20_fAng_fNH_B0p07_A0p07_G298/GDBA_CreateFeatures_v20_fAng_fNH_B0p07_A0p07_G298_v1_f781_yG.npy', allow_pickle=True)
