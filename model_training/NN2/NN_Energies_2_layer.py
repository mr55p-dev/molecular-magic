...
logging.basicConfig(
    filename=save_directory + "/" + code_name + "_" + version_no + ".log",
    level=logging.DEBUG,
    format="%(message)s",
    filemode="w",
)
...
np.save(
    "./" + save_directory + "/" + code_name + "_" + version_no + "_X_train",
    X_train,
    allow_pickle=True,
)
np.save(
    "./" + save_directory + "/" + code_name + "_" + version_no + "_X_test",
    X_test,
    allow_pickle=True,
)
np.save(
    "./" + save_directory + "/" + code_name + "_" + version_no + "_y_train",
    y_train,
    allow_pickle=True,
)
np.save(
    "./" + save_directory + "/" + code_name + "_" + version_no + "_y_test",
    y_test,
    allow_pickle=True,
)
...
with open(
    save_directory + "/" + code_name + "_" + version_no + "_errordata.csv", "w"
) as errorfile:
